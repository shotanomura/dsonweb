            ...
            <div className="welcome-content" style={{ 
                ...
                <div className="welcome-right" style={{ flex: 1, display: 'flex', justifyContent: 'center' }}>
                    <div className="login-container" style={{ 
                        ...
                        <h2 style={{ textAlign: 'center', marginBottom: '2rem', color: '#333' }}>ログイン</h2>
                        ...
                        <p style={{ textAlign: 'center', fontSize: '0.9rem', color: '#868e96' }}>
                            アカウントをお持ちでない方は <Link to="/register" style={{ color: 'var(--accent-primary, #339af0)', textDecoration: 'none' }}>新規登録</Link>
                        </p>
                    </div>
                </div>
            </div>
